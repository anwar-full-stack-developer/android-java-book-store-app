...
import com.example.bookstore.data.model.BookInfo;
import com.example.bookstore.databinding.ActivityBookStoreBinding;
...
public class BookStoreActivity extends AppCompatActivity {
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(BookStoreActivity.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(BookStoreActivity.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        BookAdapter adapter = new BookAdapter(bookInfoArrayList, BookStoreActivity.this);

                        // below line is use to add linear layout
                        // manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(BookStoreActivity.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(BookStoreActivity.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BookStoreActivity.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
